 ...
 * @version 2019-08-13
 */
public class FsSpecimenin extends DataEntity<FsSpecimenin> {
	...
	private String samplingState;		// 送样状态
	...
	private String param6;		// OD260/230
	private String param7;		// OD260/280
	private String param8;		// 测序平台
	private String param9;		// 备用参数1
	private String param10;		// 备用参数2
	private Integer state;		// 样本库存状态(0表示未用完,1表示用完)
	private String extractionDescription;		// 提取说明
	private FsStorehouse fsStorehouse;		// 储存位置
	...
	@Length(min=0, max=10, message="送样状态长度必须介于 0 和 10 之间")
	...
	@Length(min=0, max=200, message="OD260/230长度必须介于 0 和 200 之间")
	...
	@Length(min=0, max=200, message="OD260/280长度必须介于 0 和 200 之间")
	...
	@Length(min=0, max=200, message="备用参数1长度必须介于 0 和 200 之间")
	...
	@Length(min=0, max=200, message="备用参数2长度必须介于 0 和 200 之间")
	...
	public List<String> getParam8List() {
		List<String> list = Lists.newArrayList();
		if (param8 != null){
			for (String s : StringUtils.split(param8, ",")) {
				list.add(s);
			}
		}
		return list;
