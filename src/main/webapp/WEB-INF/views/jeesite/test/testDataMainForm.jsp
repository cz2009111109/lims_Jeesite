            ...
            $("#btnImport").click(function(){
                $.jBox($("#importBox").html(), {title:"导入数据", buttons:{"确定":"ok","关闭":true},
					...
					if(v=="ok"){
                        ...
                        $.ajax({
							url:'${ctx}/test/testDataMain/import/child',
                            dataType:'json',
                            type:'POST',
                            async: false,
                            data: formData,
...
<body>
	<div id="importBox" class="hide">
		<form id="importForm" action="${ctx}/test/testDataMain/import/child" method="post" enctype="multipart/form-data"
			  class="form-search" style="padding-left:20px;text-align:center;" onsubmit="loading('正在导入，请稍等...');"><br/>
			<input type="hidden" name="id" value="${testDataMain.id}">
			<input id="uploadFile" name="file" type="file" style="width:330px"/><br/><br/>　　
			<a id="childtemplate" href="${ctx}/test/testDataMain/import/childtemplate" >下载子表模板</a>
		</form>
	</div>
						...
						<shiro:hasPermission name="test:testDataMain:edit">
							...
							<tr>
								<td colspan="4">
									...
									<input id="tableSelect" class="btn btn-primary" type="button" value="弹出框选择"/>
								</td>
							</tr>
							</tfoot>
						</shiro:hasPermission>
