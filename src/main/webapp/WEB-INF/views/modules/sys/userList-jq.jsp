...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/user/listjq">用户列表</a></li>
		<shiro:hasPermission name="sys:user:edit"><li><a href="${ctx}/sys/user/form">用户添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="user" action="${ctx}/sys/user/jqGridList" method="post" class="breadcrumb form-search ">
		...
		<ul class="ul-form">
			...
			<li><label>归属部门：</label><sys:treeselect id="office" name="office.id" value="${user.office.id}" labelName="office.name" labelValue="${user.office.name}" 
				title="部门" url="/sys/office/treeData?type=2" cssClass="input-small" allowClear="true" notAllowSelectParent="false" checked="true"/></li>
	...
	<script type="text/javascript">
		...
		$('#dataGrid').dataGrid({
            ...
            colModel: [
				...
				{header:'工号', name:'office.name', index:'', width:160},
				{header:'邮箱', name:'email', index:'', width:160, sortable:false},
