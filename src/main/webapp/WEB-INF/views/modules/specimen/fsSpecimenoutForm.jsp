...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/specimen/fsSpecimenout/">样本出库列表</a></li>
		<li class="active"><a href="${ctx}/specimen/fsSpecimenout/form?id=${fsSpecimenout.id}">样本出库<shiro:hasPermission name="specimen:fsSpecimenout:edit">${not empty fsSpecimenout.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="specimen:fsSpecimenout:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="fsSpecimenout" action="${ctx}/specimen/fsSpecimenout/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="samplingBeforestate" htmlEscape="false" maxlength="50" class="input-xlarge "/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="param8" htmlEscape="false" maxlength="200" class="input-xlarge "/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="user" name="user.id" value="${fsSpecimenout.user.id}" labelName="user.name" labelValue="${fsSpecimenout.user.name}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="specimen:fsSpecimenout:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
